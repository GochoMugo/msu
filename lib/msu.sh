...
case "${1:-''}" in
  ...
  "h" | "help" )
    ...
    then
      ...
      echo "    msu execute <path> <arg>..."
      echo "    msu install-many|uninstall-many <path>..."
      ...
      echo "    im | install-many    install from module-list(s) at path(s) <path>..."
      ...
      echo "    um | uninstall-many  uninstall from module-list(s) at path(s) <path>..."
